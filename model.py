...
class AlexNet(nn.Module):
    def __init__(self, num_classes=1000):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(3, 96, kernel_size=11, stride=1, padding=2),  # input[3, 224, 224]  output[96, 55, 55]
...
def main():
    ...
    vaild_dataset = MyDataset("data_val.npy", "train")
    ...
    for epoch in range(epochs):
        ...
        if val_accurate > best_acc:
            ...
            torch.save(net.state_dict(), os.path.join(save_path, 'alex_animal.pth'))
